...
import com.aldemir.newsportal.ui.home.HomeAdapterNews
import com.bumptech.glide.Glide
import java.lang.Exception

class SearchAdapter : ListAdapter<New, SearchAdapter.ViewHolder>(CoinItemCallback) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        try {
            ...
            Log.e(HomeAdapterNews.TAG, err.message.toString())
        }
